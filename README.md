...
Client = AutoFarm:Label("FPS Lover")
...
local btns = serv:Channel("Love Pear 3000","")



btns:Button("Love Pear 3000", function()
DiscordLib:Notification("Notification", "Love Pear 3000", "Okay!")
end)


btns:Button("Love Pear 3000", function()
SomeLib:Notification("Notification", "Love Pear 3000", "Okay!")
end)

local tgls = serv:Channel("Love Pear 3000","")

tgls:Toggle("love Pear 3000",false, function(bool)
print(bool)
end)

local sldrs = serv:Channel("I love Pear","")

local sldr = sldrs:Slider("level", 0, 1000, 400, function(t)
print(t)
end)

sldrs:Button("How much i love Pear", function()
sldr:Change(50)
end)

local drops = serv:Channel("I love Pear","")


local drop = drops:Dropdown("I love Pear",{"I love Pear 1","I love Pear 2","I love Pear 3","I love Pear 4","I love Pear 5"}, function(bool)
print(bool)
end)

drops:Button("Im lazy", function()
drop:Clear()
end)

drops:Button("I really love u", function()
drop:Add("Option")
end)

local clrs = serv:Channel("I love Pear","")

clrs:Colorpicker("ESP Color", Color3.fromRGB(255,1,1), function(t)
print(t)
end)

local textbs = serv:Channel("I love Pear","")

textbs:Textbox("Love power", "Type here!", true, function(t)
print(t)
end)

local lbls = serv:Channel("I love Pear","")

lbls:Label("This is a love.")

local bnds = serv:Channel("I love Pear","")

bnds:Bind("Kill love", Enum.KeyCode.RightShift, function()
